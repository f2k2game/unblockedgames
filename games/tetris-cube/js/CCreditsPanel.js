function CCreditsPanel() {
    ...
    this._init = function () {
        ...
        _oMsgTextOutline = new createjs.Text("", "40px " + PRIMARY_FONT, "#025cce");
        ...
        _oMsgText = new createjs.Text("", "40px " + PRIMARY_FONT, "#ffd800");
        ...
        _oLinkOutline = new createjs.Text("", "40px " + PRIMARY_FONT, "#025cce");
        ...
        _oLink = new createjs.Text("", "40px " + PRIMARY_FONT, "#ffd800");
