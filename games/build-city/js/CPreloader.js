function CPreloader(){
    ...
    this.attachSprites = function(){
       ...
       _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(450, CANVAS_HEIGHT - 250, 1,30);
       _oContainer.addChild(_oMaskPreloader);
       
       _oProgressBar.mask = _oMaskPreloader;
       _oLoadingText = new createjs.Text("0%","30px "+FONT_GAME, "#fff");
       _oLoadingText.x = CANVAS_WIDTH/2;
       _oLoadingText.y = CANVAS_HEIGHT - 256;
    ...
    this.refreshLoader = function(iPerc){
        ...
        _oMaskPreloader.graphics.beginFill("rgba(255,0,0,0.01)").drawRect(450, CANVAS_HEIGHT - 250, iNewMaskWidth,30);
    };
