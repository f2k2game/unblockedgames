...
function mYepiTester(){
    ...
    s += '<input type="button" style="width:100px;" value="Game Resize" id="Tester_mYepiAPI_Resize" onclick="mYepiAPI_checkGameResize(500,500);" /> <br/>';
...
function mYepiAPI_checkGameResize(w,h){   
    try{
        mYepiAPI_gameResize(w,h);
        mYepiAPI_setTestOK("Tester_mYepiAPI_Resize", true);
    }catch(e){
        mYepiAPI_setTestOK("Tester_mYepiAPI_Resize", false);
    }
}
