function CEndPanel(oSpriteBg, bNote, bSolve, bTime, iNumHint, iScore){
    ...
    this._init = function(oSpriteBg, bNote, bSolve, bTime, iNumHint, iScore){
        ...
        _oMsgText = new createjs.Text(""," 80px "+SECONDARY_FONT, "#008df0");
        ...
        _oHelpText = new createjs.Text("","bold 40px "+PRIMARY_FONT, "#008df0");
        ...
        _aHelp[0] = new createjs.Text("","bold 40px "+PRIMARY_FONT, "#008df0");
        _aHelp[0].x = oPos.x;
        ...
        _aHelp[1] = new createjs.Text("","bold 40px "+PRIMARY_FONT, "#008df0");
        _aHelp[1].x = oPos.x;
        ...
        _aHelp[2] = new createjs.Text("","bold 40px "+PRIMARY_FONT, "#008df0");
        _aHelp[2].x = oPos.x;
        ...
        _aHelp[3] = new createjs.Text("","bold 40px "+PRIMARY_FONT, "#008df0");
        _aHelp[3].x = oPos.x;
        ...
        _oScore = new createjs.Text(""," 70px "+SECONDARY_FONT, "#008df0");
    ...
    this.show = function(iTime){
        ...
        $(s_oMain).trigger("share_event",[_iScore, szImage, szTitle, szMsg, szMsgShare]);
