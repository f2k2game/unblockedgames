function CGame(oData){
    ...
    this.gameOver = function(){  
        ...
        _oEndPanel = CEndPanel(s_oSpriteLibrary.getSprite('msg_box'),_bNoteHelpUsed, _bSolveHelpUsed, _bTimeHelpUsed, _iNumHintHelp, iScore);
    ...
    this._setEndingStateWhenSolve = function(){
        ...
        _oPanelWhenSolve.on("mousedown", this.buttonDownWhenSolve);   
        if(!s_bMobile){
            _oPanelWhenSolve.on("mouseover", this.buttonOverWhenSolve);
        }

    };
    
    this.buttonDownWhenSolve = function(){
        _oPanelWhenSolve.off("mousedown", this.buttonDownWhenSolve);   
        if(!s_bMobile){
            _oPanelWhenSolve.off("mouseover", this.buttonOverWhenSolve);
        }
